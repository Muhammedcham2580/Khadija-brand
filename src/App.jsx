...
import { ShoppingBag, Menu, X, Heart, ArrowRight, Star, Sparkles, Upload, Phone, MessageCircle, Instagram, ZoomIn } from 'lucide-react';
...
export default function App() {
  ...
  const addToCart = (product) => {
    ...
    // Popup removed - item added silently
  };
...
✅ Order placed successfully! We'll deliver to your address.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          {menuOpen && (
            <nav className="md:hidden mt-4 pb-4 space-y-3">
              <button
                onClick={() => scrollToSection("hero")}
                className="block text-gray-700 hover:text-purple-600 font-medium transition w-full text-left"
              >
                Home
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection("newsletter")}
                className="block text-rose-500 font-semibold hover:text-rose-600 transition w-full text-left"
              >
                Hours & Contact
              </button>
            </nav>
      ...
      <section
        id="products"
        className="py-20 px-6 bg-gradient-to-br from-purple-50 to-rose-50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4">
          ...
          <div className="flex justify-center gap-2 md:gap-4 mb-12 flex-wrap">
            <button
              ...
              className={`px-4 md:px-6 py-2 md:py-3 rounded-full font-bold transition text-sm md:text-base ${
                selectedCategory === "all"
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-2 md:top-4 left-2 md:left-4 z-10">
                    ...
                    >
                      <Heart
                        className={`w-5 h-5 md:w-6 md:h-6 cursor-pointer transition ${
                  ...
                  <div className="absolute top-2 md:top-4 right-10 md:right-16 z-10">
                    <label
                      className="cursor-pointer bg-white/90 hover:bg-white p-1.5 md:p-2 rounded-full transition"
      ...
      <section
        id="newsletter"
        className="py-20 px-6 bg-gradient-to-r from-purple-600 via-rose-500 to-purple-600"
      >
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div
            className={`inline-block px-4 md:px-6 py-2 md:py-3 rounded-full text-base md:text-lg font-bold mb-6 ${
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              ...
              <div>
                ...
                <p className="mb-2 text-sm md:text-base">
                  Phone/WhatsApp: 7100554
                </p>
                <p className="text-xs md:text-sm opacity-90">
                  💳 We accept: Wave, Cash on Delivery
                </p>
              </div>
            </div>
          </div>
      ...
      {/* PRODUCT DETAIL MODAL - SHEIN STYLE */}
      {selectedProduct && (
          ...
          <div className="min-h-screen px-4 py-8">
            <div className="max-w-6xl mx-auto bg-white rounded-3xl overflow-hidden">
              <button
                ...
                className="absolute top-4 right-4 z-10 bg-white/90 backdrop-blur-sm text-gray-800 p-3 rounded-full hover:bg-white transition shadow-lg"
              >
                <X className="w-6 h-6" />
              </button>
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="bg-gray-50 p-6">
                  <div className="relative mb-4 group">
                    ...
                    />
                    <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-bold flex items-center gap-2">
                ...
                <div className="p-6 md:p-8">
                  <div className="mb-4">
                    <span className="bg-gradient-to-r from-purple-600 to-rose-500 text-white px-4 py-2 rounded-full text-sm font-bold">
                      {selectedProduct.tag}
                    </span>
                  </div>
                  ...
                  <div className="text-4xl md:text-5xl font-black bg-gradient-to-r from-purple-600 to-rose-500 bg-clip-text text-transparent mb-6">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-purple-600 to-rose-500 text-white py-4 rounded-full font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      ...
                      className={`w-full py-4 rounded-full font-bold text-lg border-2 transition-all flex items-center justify-center gap-2 ${
                  ...
                  <div className="mt-6 p-4 bg-purple-50 rounded-2xl">
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-green-500 text-white py-2 rounded-full text-sm font-bold hover:bg-green-600 transition flex items-center justify-center gap-2"
                      >
                      ...
                      <a
                        href="tel:+7100554"
                        className="flex-1 bg-purple-600 text-white py-2 rounded-full text-sm font-bold hover:bg-purple-700 transition flex items-center justify-center gap-2"
                      >
                ...
                <>
                  ...
                  <div className="space-y-4 mb-6">
                    {cart.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 md:gap-4 bg-gray-50 p-3 md:p-4 rounded-2xl"
                      >
                        <img
                          src={item.img}
                          alt={item.name}
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-purple-600 font-bold text-sm md:text-base">
                            D{item.price}
                          </p>
                        </div>
                        <button
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 md:gap-4">
                          <button
                            ...
                            className={`p-3 md:p-4 rounded-xl border-2 font-bold transition text-sm md:text-base ${
                  ...
                  <div className="bg-gradient-to-r from-purple-600 to-rose-500 text-white p-4 md:p-6 rounded-2xl mb-6">
                    ...
                    <p className="text-xs md:text-sm mt-2 opacity-90">
                      Payment via {orderDetails.paymentMethod.toUpperCase()} •
                      Free delivery within Serekunda
                    </p>
                  </div>
                  ...
                  <p className="text-center text-xs md:text-sm text-gray-500 mt-4">
                    Your order will be sent to our WhatsApp. We'll confirm and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-xs md:text-sm">
                Seysowe Branding - Premium fashion and jewelry. Located at
                Manjai New Road, The Gambia. Your destination for elegant style.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-3 mb-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 md:w-10 md:h-10 bg-white/10 rounded-full hover:bg-gradient-to-r hover:from-purple-600 hover:to-rose-500 transition flex items-center justify-center"
                  title="Instagram"
                >
                  <Instagram className="w-4 h-4 md:w-5 md:h-5" />
                </a>
                <a
                  href="https://tiktok.com/@seysowe"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 md:w-10 md:h-10 bg-white/10 rounded-full hover:bg-gradient-to-r hover:from-purple-600 hover:to-rose-500 transition flex items-center justify-center text-xs font-bold"
                  title="TikTok"
                >
                  TT
                </a>
                <a
                  href="https://snapchat.com/add/seysowe"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 md:w-10 md:h-10 bg-white/10 rounded-full hover:bg-gradient-to-r hover:from-purple-600 hover:to-rose-500 transition flex items-center justify-center text-xs font-bold"
                  title="Snapchat"
              ...
              <div>
                ...
                <a
                  href="tel:+7100554"
                  className="text-xs md:text-sm text-white hover:text-purple-400 transition block mb-1"
                >
                  📞 7100554
                </a>
